        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-2 md:col-span-1">
            <div className="p-4 rounded-lg bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  <p className="text-2xl font-bold text-green-500">{status.active_agents}</p>
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="p-4 rounded-lg bg-purple-50 dark:bg-purple-900/10 border border-purple-200 dark:border-purple-800">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <p className="text-2xl font-bold text-orange-500">{status.pending_tasks}</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">Pending</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-blue-500">{status.running_tasks}</p>
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="p-4 rounded-lg bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800">
              ...
              <p className="text-2xl font-bold text-green-500">{status.completed_tasks}</p>
            </div>
          </div>
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="p-4 rounded-lg bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800">
              ...
              <p className="text-2xl font-bold text-red-500">{status.failed_tasks}</p>
            </div>
          </div>
          
          <div className="col-span-2">
            <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-900/10 border border-gray-200 dark:border-gray-800">
              <h3 className="text-sm font-medium text-gray-800 dark:text-gray-200 mb-2">System Load</h3>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                {(status.system_load * 100).toFixed(1)}% | Updated: {formatDate(status.timestamp)}
              </p>
            </div>
          </div>
        </div>
